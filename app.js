//Bu altyapı aXNNy tarafından hazırlanmıştır başka yerlerde paylaşılması yasaktır !
...
client.on('message', async msg => {
    ...
    .setTitle(':warning: | İlk olarak sesli bir kanala giriş yapmanız gerek.'));
      ...
      .setTitle(`**? | Oynatma Listesi: **${playlist.title}** Kuyruğa Eklendi!**`)
         ...
         .setTitle('aXNNyAltyapı Müzik | Şarkı Seçimi')
   ...
   .setTitle(`:warning: Şuanki Ses Seviyesi: **${serverQueue.volume}**`)
    ...
    .setColor('RED'));
		return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RED')
    .setTitle("aXNNyAltyapı Bot Müzik | Çalan")                            
    ...
    .setColor('RED'));
		  return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
     .setTitle('aXNNyAltyapı Bot Müzik | Şarkı Kuyruğu')
...
function play(guild, song) {
  ...
  .setTitle("**aXNNyAltyapı Bot Müzik | :microphone: Müzik Başladı**")
